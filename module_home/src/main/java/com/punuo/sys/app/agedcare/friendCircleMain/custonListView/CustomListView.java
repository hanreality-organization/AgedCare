package com.punuo.sys.app.agedcare.friendCircleMain.custonListView;
...
public class CustomListView extends ListView implements OnScrollListener {
	...
	public final static int pScrollState=0;
...
//	}
	...
	private void addHeadView() {
		mHeadView = (LinearLayout) mInflater.inflate(R.layout.micro_head, null);
...
//			endingView.setVisibility(View.VISIBLE);
	...
	public void onScrollStateChanged(AbsListView pView, int pScrollState) {
		System.out.println("滑动     "+pScrollState);
	...
	private void  changeEndViewByState() {
		if (mCanLoadMore) {
			...
			case ENDINT_MANUAL_LOAD_DONE:// 手动刷新完成
				...
				mEndLoadTipsTextView.setClickable(false);
				mEndRootView.setVisibility(View.VISIBLE);
				break;
...
//				}
	 ...
	 * @version 1.0
	 */
	public void onLoadMoreComplete(boolean aa) {
		if(aa){
			mEndState = ENDINT_AUTO_LOAD_DONE;
		}else{
			mEndState = ENDINT_MANUAL_LOAD_DONE;
