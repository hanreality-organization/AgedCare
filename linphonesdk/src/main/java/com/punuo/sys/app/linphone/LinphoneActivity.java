...
import com.punuo.sys.app.linphone.frgment.CallAudioFragment;
import com.punuo.sys.app.linphone.frgment.CallVideoFragment;
...
public class LinphoneActivity extends AppCompatActivity implements ComButton.onComClick, View.OnClickListener {
    ...
    protected synchronized void onResume() {
        ...
        LinphoneService.instance().removeNarrow();
    ...
    private void answer() {
        if (mCall != null) {
            ...
            boolean isLowBandwidthConnection = !LinphoneUtil.isHighBandwidthConnection(LinphoneService.instance().getApplicationContext());
            if (params != null) {
