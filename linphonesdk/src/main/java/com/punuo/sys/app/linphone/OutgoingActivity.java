...
import com.punuo.sys.app.linphone.frgment.AudioPreViewFragment;
import com.punuo.sys.app.linphone.frgment.VideoPreViewFragment;
import com.punuo.sys.app.linphone.widget.ComButton;
...
import static com.punuo.sys.app.linphone.LinphoneActivity.CALL;
...
public class OutgoingActivity extends AppCompatActivity implements ComButton.onComClick {
        ...
        mListener = new LinphoneCoreListenerBase() {
            ...
            public void callState(LinphoneCore lc, LinphoneCall call, LinphoneCall.State state, String message) {
                ...
                if (LinphoneCall.State.Connected == state) {
                    ...
                    // 对方接听
                    LinphoneActivity.openActivity(OutgoingActivity.this, VOIP_CALL, true);
    ...
    private void lookupOutgoingCall() {
        if (LinphoneManager.getLcIfManagerNotDestroyedOrNull() != null) {
            ...
            LinLog.e(LinphoneHelper.TAG, "lookupOutgoingCall:" + calls.size());
            ...
            if (isInCall) {
                //跳转到通话界面
                LinphoneActivity.openActivity(this, VOIP_CALL);
                finish();
    ...
    private static class VoipHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case CALL:
                    LinphoneHelper.isInCall = false;
                    LinphoneManager.getInstance().newOutgoingCall(LinphoneHelper.friendName, LinphoneHelper.isVideoEnable);
                    break;
            }
        }
    }
