...
import com.punuo.sys.app.linphone.CallManager;
...
import com.punuo.sys.app.linphone.LinphoneUtil;
import com.punuo.sys.app.linphone.R;
import com.punuo.sys.app.linphone.compatibility.Compatibility;
import com.punuo.sys.app.linphone.compatibility.CompatibilityScaleGestureDetector;
import com.punuo.sys.app.linphone.compatibility.CompatibilityScaleGestureListener;
...
public class CallVideoFragment extends Fragment implements OnGestureListener, OnDoubleTapListener, CompatibilityScaleGestureListener {
    ...
    private LinphoneActivity inCallActivity;
    ...
    public void onStart() {
        super.onStart();
        inCallActivity = (LinphoneActivity) getActivity();
        if (inCallActivity != null) {
    ...
    public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
        if (LinphoneUtil.isCallEstablished(LinphoneManager.getLc().getCurrentCall())) {
            if (mZoomFactor > 1) {
