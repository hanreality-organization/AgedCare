...
{  
   ...
   public void onDlgRefer(InviteDialog dialog, NameAddress refer_to, NameAddress referred_by, Message msg);

   /** When a response is received for a REFER request within the dialog */ 
   public void onDlgReferResponse(InviteDialog dialog, int code, String reason, Message msg);

   /** When an incoming NOTIFY request is received within the dialog */ 
   public void onDlgNotify(InviteDialog dialog, String event, String sipfragment, Message msg);

   /** When a response is received for a NOTIFY request within the dialog */ 
   //public void onDlgNotifyResponse(org.org.zoolu.sip.dialog.InviteDialog dialog, int code, String reason, Message msg);

   /** When an incoming request is received within the dialog
     * different from INVITE, CANCEL, ACK, BYE, REFER, NOTIFY */ 
   public void onDlgAltRequest(InviteDialog dialog, String method, String body, Message msg);

   /** When a response is received for a request within the dialog 
     * different from INVITE, CANCEL, ACK, BYE, REFER, NOTIFY */ 
   public void onDlgAltResponse(InviteDialog dialog, String method, int code, String reason, String body, Message msg);

   /** When a request timeout expires within the dialog
     * different from INVITE, CANCEL, ACK, BYE, REFER, NOTIFY */ 
   //public void onDlgAltTimeout(org.org.zoolu.sip.dialog.InviteDialog dialog, String method);
}
