...
public class SipStack extends Configure
{
   ...
   /** String value "no-ua-info" used for setting no 'Device-Agent' header filed. */
   ...
   /** UA info included in request messages in the 'Device-Agent' header field.
     * Use "NONE" if the 'Device-Agent' header filed must not be added. */
