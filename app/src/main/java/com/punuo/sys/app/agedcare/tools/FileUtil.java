...
public class FileUtil {
    ...
    private static String local_image_path;
    ...
    public static final String DEFAULT_APK_DIR
            = Environment.getExternalStorageDirectory() + "/Android/data/com.punuo.sys.app.agedcare" + File.separator + "apk" + File.separator;
