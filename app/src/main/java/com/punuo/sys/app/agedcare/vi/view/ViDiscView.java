package com.punuo.sys.app.agedcare.vi.view;
...
public class ViDiscView extends RelativeLayout {
    ...
    public ViDiscView(Context context) {
        this(context, null);
    }

    public ViDiscView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ViDiscView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        mScreenWidth = ViCommonUtils.getScreenWidth(context);
        mScreenHeight = ViCommonUtils.getScreenHeight(context);
    }
    ...
    private void initDiscImg() {
        ImageView mDiscBackground = findViewById(R.id.viiv_discbackground);
        ...
        int marginTop = (int) (ViCommonUtils.SCALE_DISC_MARGIN_TOP * mScreenHeight);
...
//        mNeedleAnimator = ObjectAnimator.ofFloat(mIvNeedle, View.ROTATION, ViCommonUtils
...
//    }
    ...
    public Drawable getDiscDrawable(Bitmap bitmap) {
        int discSize = (int) (mScreenWidth * ViCommonUtils.SCALE_DISC_SIZE);
        int musicPicSize = (int) (mScreenWidth * ViCommonUtils.SCALE_MUSIC_PIC_SIZE);
        ...
        int musicPicMargin = (int) ((ViCommonUtils.SCALE_DISC_SIZE - ViCommonUtils
