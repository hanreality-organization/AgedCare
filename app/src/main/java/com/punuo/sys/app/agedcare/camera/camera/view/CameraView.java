package com.punuo.sys.app.agedcare.camera.camera.view;
...
public class CameraView extends SurfaceView implements CameraOperation {
    ...
    public boolean startRecord() {
        ...
        String path = FileOperateUtil.getFolderPath(getContext(), FileOperateUtil.TYPE_VIDEO, "Camera");
...
//			}
    ...
    private Bitmap saveThumbnail() throws FileNotFoundException, IOException {
        if (mRecordPath != null) {
            ...
            if (bitmap != null) {
                String mThumbnailFolder = FileOperateUtil.getFolderPath(getContext(), FileOperateUtil.TYPE_THUMBNAIL, "Camera");
    ...
    private boolean openCamera() {
        ...
        if (mIsFrontCamera) {
            ...
            try {
                System.out.println("cameraId_out = " + cameraId_out);
